...
const CATALOG: { provider: string; category: string; name: string }[] = [
  ...
  { provider: "instagram_ads", category: "ADVERTISING", name: "Instagram Ads" },
  { provider: "facebook_ads", category: "ADVERTISING", name: "Facebook Ads" },
  { provider: "google_ads", category: "ADVERTISING", name: "Google Ads" },
  { provider: "tiktok_ads", category: "ADVERTISING", name: "TikTok Ads" },
  { provider: "google_search_console", category: "ANALYTICS", name: "Google Search (Organic)" },
